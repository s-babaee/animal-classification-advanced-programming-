...
void Mammal::showMsg(QString text, QString type){
...
Mammal::Mammal(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Mammal)
{
    ui->setupUi(this);
    this->setWindowTitle("Mammal");
}
...
void Mammal::on_pushButtonBack_clicked()
{
    Add *add = new Add;
    add->show();
    this->hide();
...
void Mammal::on_pushButtonSave_clicked()
{
